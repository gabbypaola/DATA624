...
Below is the distribution after resolving the NA value and the outlier. It is still has a right skew and would be beneficial to do a transfomation prior to modeling and forecasting. The time series plot of the variable shows strong seasonality with an upward trend picking up around 2008-2009.
