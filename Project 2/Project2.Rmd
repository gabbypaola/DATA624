...
```{r}
nzvU<- nearZeroVar(train, saveMetrics= TRUE)
filter(nzv, nzv=="TRUE")
```
...
#remove pH from the train dataset in order to only transform the predictors
train_features <- train %>% 
  dplyr::select(-c(PH))

#remove nvz, correlated values, center and scale, apply BoxCox for normalization
